...
def sample_destinations():
    ...
    return [
        {"name": "Test1", "url": "apprise://test1", "enabled": True},
        {"name": "Test2", "url": "apprise://test2", "enabled": True},
        {"name": "Disabled", "url": "apprise://disabled", "enabled": False},
    ]
...
class TestNotifier:
    ...
    def test_setup_destinations_disabled(self, sample_destinations):
        ...
        with patch("apprise.Apprise") as mock_apprise:
            mock_instance = Mock()
            mock_apprise.return_value = mock_instance
            _ = Notifier(sample_destinations)
